    ...
    <div className='details-box'>
      <div className='box'>
        ...
        <div className='imageDetails'>
          <img src={details['im:image'][0]?.label.replace(/(?<!\d)\d{2,2}x\d{2,2}(?!\d)/g, '300x300')} alt={details['im:name']?.label} />
        </div>
        <p><a
          target="_blank"
          ...
          href={details['im:image'][0]?.label.replace(/(?<!\d)\d{2,2}x\d{2,2}(?!\d)/g, '2000x3000')} alt='img link'
        >Download poster!</a></p>
